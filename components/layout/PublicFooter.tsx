      ...
      <div className="site-footer__top container">
        <div className="site-footer__brandcol">
          ...
          <div className="site-footer__social" aria-label="Social links">
            ...
            <a href="https://wa.me/250788945163" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
        ...
        <div className="site-footer__links">
          ...
          <div className="site-footer__col site-footer__col--contact">
            ...
            <a href="mailto:ntihemuka@volcanoartscenterinc.org.rw" className="site-footer__contact">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
                <rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 6-10 7L2 6"/>
              </svg>
              <span>ntihemuka@volcanoartscenterinc.org.rw</span>
            </a>
            <a href="tel:+250788945163" className="site-footer__contact">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">

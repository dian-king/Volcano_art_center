...
const SLIDES = [
  ...
  { label: "Basket Weaving",   bg: "#2A1F0F", img: "/images/WhatsApp Image 2026-06-30 at 8.51.42 PM (1).jpeg" },
  { label: "Talent Programme", bg: "#122A17", img: "/images/talent-kids-drawing-2.jpeg" },
]
